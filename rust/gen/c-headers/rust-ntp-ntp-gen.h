...
int8_t rs_ntp_parse_request(const Flow * _flow, void * state, const void * _pstate, const uint8_t * input, uint32_t input_len, const void * _data);
int8_t rs_ntp_parse_response(const Flow * _flow, void * state, const void * _pstate, const uint8_t * input, uint32_t input_len, const void * _data);
...
AppProto ntp_probing_parser(const Flow * _flow, const uint8_t * input, uint32_t input_len, const uint32_t * _offset);
