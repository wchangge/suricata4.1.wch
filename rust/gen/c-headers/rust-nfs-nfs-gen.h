...
void rs_nfs3_tx_set_logged(NFSState * _state, NFSTransaction * tx, uint32_t logged);
uint32_t rs_nfs3_tx_get_logged(NFSState * _state, NFSTransaction * tx);
void rs_nfs3_state_set_tx_detect_state(NFSTransaction * tx, DetectEngineState * de_state);
